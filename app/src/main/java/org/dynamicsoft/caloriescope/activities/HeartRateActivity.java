...
public class HeartRateActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SensorEventListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_exit) {
            HeartRateActivity.this.moveTaskToBack(true);
        }
